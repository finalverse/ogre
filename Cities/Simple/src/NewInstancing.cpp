...
//------------------------------------------------------------------------------
City_NewInstancing::City_NewInstancing() : NUM_INST_ROW(50), NUM_INST_COLUMN(50), mCurrentManager(0), mCurrentMaterialSet(c_materialsTechniques), mCurrentFlags(0), mSkinningTechniques(NULL)
{
...
//------------------------------------------------------------------------------
bool City_NewInstancing::frameRenderingQueued(const FrameEvent& evt)
{
    ...
    return SdkCity::frameRenderingQueued(evt);        // don't forget the parent class updates!
}

//------------------------------------------------------------------------------
bool City_NewInstancing::keyPressed(const KeyboardEvent& evt)
{
    ...
    return SdkCity::keyPressed(evt);
}

//------------------------------------------------------------------------------
void City_NewInstancing::setupContent()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::setupLighting()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::switchInstancingTechnique()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::switchSkinningTechnique(int index)
{
    switch(index)
    {
        default:
...
//------------------------------------------------------------------------------
void City_NewInstancing::createEntities(int technique)
{
    std::mt19937 rng;
...
//------------------------------------------------------------------------------
void City_NewInstancing::createInstancedEntities()
{
    std::mt19937 rng;
...
//------------------------------------------------------------------------------
void City_NewInstancing::createSceneNodes()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::clearScene()
{
...
//-----------------------------------------------------------------------------------
void City_NewInstancing::destroyManagers()
{
    mSceneMgr->destroyInstanceManager(mCurrentManager);;
}

//------------------------------------------------------------------------------
void City_NewInstancing::cleanupContent()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::animateUnits( float timeSinceLast )
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::moveUnits( float timeSinceLast )
{
    Real fMovSpeed = 1.0f;
...
//------------------------------------------------------------------------------
Quaternion City_NewInstancing::lookAt( const Vector3 &normDir )
{
    return Math::lookRotation(normDir.normalisedCopy(), Vector3::UNIT_Y);
}

//------------------------------------------------------------------------------
void City_NewInstancing::defragmentBatches()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::setupGUI()
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::itemSelected( SelectMenu* menu )
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::buttonHit( OgreBites::Button* button )
{
    if( button == mDefragmentBatches ) defragmentBatches();
}

//------------------------------------------------------------------------------
void City_NewInstancing::checkBoxToggled( CheckBox* box )
{
...
//------------------------------------------------------------------------------
void City_NewInstancing::sliderMoved( Slider* slider )
{
...
void City_NewInstancing::checkHardwareSupport()
{
