...
class _OgreCityClassExport City_Fresnel : public SdkCity, public RenderTargetListener
{
public:
    ...
    City_Fresnel() : NUM_FISH(30), NUM_FISH_WAYPOINTS(10), FISH_PATH_LENGTH(200), FISH_SCALE(2)
    {
        mInfo["Title"] = "Fresnel";
