...
class _OgreCityClassExport City_Lighting : public SdkCity, public RenderObjectListener
{
...
protected:
    ...
    void setupLights()
    {
        ...
        // Create the occlusion queries to be used in this City
        try {
        ...
        {
            LogManager::getSingleton().logError("City_Lighting - failed to create hardware occlusion query");
        }
