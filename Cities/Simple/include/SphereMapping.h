...
/* NOTE: This City simply displays an object with an sphere mapped material. The really relevant stuff
...
class _OgreCityClassExport City_SphereMapping : public SdkCity
{
public:
