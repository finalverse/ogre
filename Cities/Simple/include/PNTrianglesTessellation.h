...
class _OgreCityClassExport City_PNTriangles : public SdkCity
{
public:
        ...
        : mMoveLights (true)
    {
        ...
        mInfo["Description"] = "City for parametric PN-Triangles tessellation algorithm";
...
protected:
    ...
    {
        // clean up properly to avoid interfering with subsequent Cities
        for (std::map<String, StringVector>::iterator it = mPossibilities.begin(); it != mPossibilities.end(); it++)
