...
/* NOTE: This City simply displays an object with a transparent material. The really relevant stuff
...
class _OgreCityClassExport City_Transparency : public SdkCity
{
public:
