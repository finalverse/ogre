...
class _OgreCityClassExport City_Terrain : public SdkCity
{
public:
    City_Terrain()
    ...
    bool frameRenderingQueued(const FrameEvent& evt) override
    {
        ...
        return SdkCity::frameRenderingQueued(evt); // don't forget the parent updates!
    }
    ...
    {
        mKeyPressed = 0;
        return SdkCity::keyReleased(evt);
    }
...
protected:
    ...
    /*-----------------------------------------------------------------------------
      | Extends setupView to change some initial camera settings for this city.
      -----------------------------------------------------------------------------*/
