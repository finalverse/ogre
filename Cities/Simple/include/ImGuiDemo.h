...
class _OgreCityClassExport City_ImGui : public SdkCity, public RenderTargetListener
{
public:
    // Basic constructor
    City_ImGui()
    ...
    void setupContent(void) override
    {
        ...
        /*
            ...
            OgreBites::CityBrowser does this on behalf of the ImGuiDemo but custom applications will need to
