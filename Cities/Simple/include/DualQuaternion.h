#ifndef __DualQuaternion_City_H__
#define __DualQuaternion_City_H__
...
class _OgreCityClassExport City_DualQuaternion : public SdkCity
{
 public:
 City_DualQuaternion() : ent(0), entDQ(0), totalTime(0)
#if defined(INCLUDE_RTSHADER_SYSTEM) && defined(RTSHADER_SYSTEM_BUILD_EXT_SHADERS)
