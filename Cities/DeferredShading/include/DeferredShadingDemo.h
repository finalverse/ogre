...
class _OgreCityClassExport City_DeferredShading : public SdkCity, public RenderTargetListener
{
protected:
    Light* mMainLight;
...
public:
    City_DeferredShading()
    {
        mInfo["Title"] = "Deferred Shading";
        mInfo["Description"] = "A city implementation of a deferred renderer using the compositor framework.";
