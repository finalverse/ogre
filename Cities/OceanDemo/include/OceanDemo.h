...
#ifndef _City_Ocean_H_
#define _City_Ocean_H_
...
class _OgreCityClassExport City_Ocean : public SdkCity
{
public:
    City_Ocean();
protected:
...
/*************************************************************************
                        City_Ocean Methods
*************************************************************************/
void City_Ocean::cleanupContent()
{
...
//--------------------------------------------------------------------------
void City_Ocean::setupContent(void)
{
...
//--------------------------------------------------------------------------
void City_Ocean::sliderMoved(Slider* slider)
{
    using namespace Ogre;
...
//--------------------------------------------------------------------------
void City_Ocean::changePage(int pageNum /* = -1 : toggle */)
{
...
void City_Ocean::itemSelected(SelectMenu *menu)
{
...
bool City_Ocean::frameRenderingQueued(const FrameEvent& evt)
{
...
void City_Ocean::buttonHit(OgreBites::Button* button)
{
    //Only one button - change page
    changePage();
}

void City_Ocean::checkBoxToggled(CheckBox* cb)
{
    //Only one checkbox
    mSpinLight = cb->isChecked();
}

#endif  // end _City_Ocean_H_
