...
class _OgreCityClassExport InfiniteFrustum : public Frustum
{
public:
...
class _OgreCityClassExport City_ShaderSystem : public SdkCity
{
public:
    City_ShaderSystem();
    ~City_ShaderSystem();
...
//  virtual void setupView();
    ...
    /** @see City::setupContent. */
    void setupContent() override;

    /** Setup the UI for the City. */
    void setupUI();
    
    /** @see City::setupContent. */
    void cleanupContent() override;
    
    /** @see City::unloadResources. */
