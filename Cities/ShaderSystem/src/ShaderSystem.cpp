...
//-----------------------------------------------------------------------
City_ShaderSystem::City_ShaderSystem() :
...
void City_ShaderSystem::_shutdown()
{
...
void City_ShaderSystem::checkBoxToggled(CheckBox* box)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::itemSelected(SelectMenu* menu)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::buttonHit( OgreBites::Button* b )
{
...
//--------------------------------------------------------------------------
void City_ShaderSystem::sliderMoved(Slider* slider)
{
...
//-----------------------------------------------------------------------
bool City_ShaderSystem::frameRenderingQueued( const FrameEvent& evt )
{
    ...
    return SdkCity::frameRenderingQueued(evt);
}

//-----------------------------------------------------------------------
void City_ShaderSystem::setupContent()
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::setupUI()
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::cleanupContent()
{   
...
//-----------------------------------------------------------------------
void City_ShaderSystem::setCurrentLightingModel(ShaderSystemLightingModel lightingModel)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::setSpecularEnable(bool enable)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::setPerPixelFogEnable( bool enable )
{
#ifdef RTSHADER_SYSTEM_BUILD_EXT_SHADERS
...
void City_ShaderSystem::setAtlasBorderMode( bool enable )
{
#ifdef RTSHADER_SYSTEM_BUILD_EXT_SHADERS
...
//-----------------------------------------------------------------------
void City_ShaderSystem::updateSystemShaders() 
{
...
void City_ShaderSystem::generateShaders(Entity* entity)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::createDirectionalLight()
{
    Light*  light;
    Vector3 dir;
...
//-----------------------------------------------------------------------
void City_ShaderSystem::createPointLight()
{
    Light*  light;
...
//-----------------------------------------------------------------------
void City_ShaderSystem::createSpotLight()
{
    Light*  light;
...
void City_ShaderSystem::addModelToScene(const String &  modelName)
{
...
void City_ShaderSystem::updateAddLotsOfModels(bool addThem)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::updateInstancedViewports(bool enabled)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::updateLightState(const String& lightName, bool visible)
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::applyShadowType(int menuIndex)
{
    // Grab the scheme render state.                                                
...
//-----------------------------------------------------------------------
void City_ShaderSystem::testCapabilities( const RenderSystemCapabilities* caps )
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::unloadResources()
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::pickTargetObject( const MouseButtonEvent &evt )
{
    int xPos   = evt.x;
    int yPos   = evt.y;
...
//-----------------------------------------------------------------------
void City_ShaderSystem::updateTargetObjInfo()
{
    if (mTargetObj == NULL)
        return;
...
//-----------------------------------------------------------------------
void City_ShaderSystem::changeTextureLayerBlendMode()
{
...
//-----------------------------------------------------------------------
bool City_ShaderSystem::mousePressed(const MouseButtonEvent& evt)
{
...
//-----------------------------------------------------------------------
bool City_ShaderSystem::mouseReleased(const MouseButtonEvent& evt)
{
...
//-----------------------------------------------------------------------
bool City_ShaderSystem::mouseMoved(const MouseMotionEvent& evt)
{
...
void City_ShaderSystem::destroyInstancedViewports()
{
...
//-----------------------------------------------------------------------
void City_ShaderSystem::destroyInstancedViewportsFactory()
{
...
void City_ShaderSystem::createInstancedViewports()
{
    if (mInstancedViewportsFactory == NULL)
    {
...
void City_ShaderSystem::createMaterialForTexture( const String & texName, bool isTextureAtlasTexture )
{
...
ManualObject* City_ShaderSystem::createTextureAtlasObject()
{
