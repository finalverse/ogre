...
class _OgreCityClassExport City_Compositor : public SdkCity
{
 public:
    City_Compositor();
...
/*************************************************************************
                            City_Compositor Methods
*************************************************************************/
City_Compositor::City_Compositor()
{
...
void City_Compositor::setupView()
{
    SdkCity::setupView();
...
void City_Compositor::setupContent(void)
{
...
void City_Compositor::registerCompositors(void)
{
...
void City_Compositor::changePage(size_t pageNum)
{
...
void City_Compositor::cleanupContent(void)
{
...
void City_Compositor::setupControls(void)
{
...
void City_Compositor::checkBoxToggled(OgreBites::CheckBox * box)
{
...
void City_Compositor::buttonHit(OgreBites::Button* button)
{
...
void City_Compositor::itemSelected(OgreBites::SelectMenu* menu)
{
...
void City_Compositor::setupScene(void)
{
...
bool City_Compositor::frameRenderingQueued(const FrameEvent& evt)
{
...
void City_Compositor::createEffects(void)
{
    /// Motion blur effect
...
void City_Compositor::createTextures(void)
{
    using namespace Ogre;
