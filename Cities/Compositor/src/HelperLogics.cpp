    ...
    case 701: // rt_bloom1
        {
            ...
            fparams->setNamedConstant("cityOffsets", mBloomTexOffsetsHorz[0], 15);
            fparams->setNamedConstant("cityWeights", mBloomTexWeights[0], 15);
    ...
    case 700: // rt_bloom0
        {
            ...
            Ogre::GpuProgramParametersSharedPtr fparams =
                mat->getTechnique(0)->getPass(0)->getFragmentProgramParameters();
            fparams->setNamedConstant("cityOffsets", mBloomTexOffsetsVert[0], 15);
            fparams->setNamedConstant("cityWeights", mBloomTexWeights[0], 15);
