...
namespace OgreBites {
    ...
    void City_Isosurf::testCapabilities(const RenderSystemCapabilities* caps)
    {
        requireMaterial("Ogre/Isosurf/TessellateTetrahedra");
    }

    // Just override the mandatory create scene method
    void City_Isosurf::setupContent(void)
    {
    ...
    void City_Isosurf::cleanupContent()
    {
        MeshManager::getSingleton().remove(mTetrahedraMesh);
    }

    bool City_Isosurf::frameRenderingQueued(const FrameEvent& evt)
    {
