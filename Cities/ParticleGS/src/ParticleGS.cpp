...
struct FireworkParticle
{
    ...
    City_ParticleGS::City_ParticleGS()
    {
    ...
    void City_ParticleGS::createProceduralParticleSystem()
    {
    ...
    void City_ParticleGS::testCapabilities(const RenderSystemCapabilities* caps)
    {
        requireMaterial("Ogre/ParticleGS/Generate");
    }

    void City_ParticleGS::setupContent(void)
    {
    ...
    void City_ParticleGS::cleanupContent()
    {
...
#ifdef LOG_GENERATED_BUFFER
    bool City_ParticleGS::frameEnded(const FrameEvent& evt)
    {
